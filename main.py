...
#so that we get to the middle of the player and if he crosses the pipe increase his score by 1
        ...
        if 0<upperPipes[0]['x']<5:#just abt to exit add a new pipe when the first pipe is abt to cross the leftmost part of the screen
...
def getRandomPipe():
    ...
    y2=offset+random.randrange(0,int(SCREENHEIGHT-GAME_SPRITES['base'].get_height()-offset*1.2))#Syntax. random.randrange(start, stop, step)
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers']=(
        pygame.image.load('gallery/sprites/0.png').convert_alpha(),#The new surface will be in a format suited for quick 
    ...
    GAME_SOUNDS['die']=pygame.mixer.Sound('gallery/audio/die.wav')#due to this object being created can play song using .play() method
